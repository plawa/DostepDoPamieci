...
Szczegó³owy opis zawarty jest w sprawozdaniu.
...
Aby uruchomiæ aplikacjê, nale¿y nastêpnie otworzyæ plik wykonywalny (*.exe), który znajduje siê w folderze "/debug".
...
Po uzyskaniu pierwszej serii wyników, naciœniêcie dowolnego klawisza ponawia test, a przycisk "Enter" - zwiêksza skok odczytu kolejnych elementów.